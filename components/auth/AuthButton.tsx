    ...
    <>
      <div className="flex items-center">
        <button
          ...
          className="btn btn-cyan px-2.5 py-1.5 sm:px-3.5 sm:py-2 text-[11px] sm:text-xs font-bold whitespace-nowrap flex items-center gap-1.5 shadow-[0_0_15px_rgba(6,182,212,0.25)] min-h-[34px] sm:min-h-[38px]"
          aria-label="Authenticate with Google"
        >
          <Lock className="w-3 h-3 text-white/90 shrink-0" />
          <span className="md:hidden font-mono tracking-wider">LOGIN</span>
          <span className="hidden md:inline font-mono tracking-wider">AUTHENTICATE</span>
        </button>
      </div>
